...
find /data1/ -xdev -type f -path "*/var/cache/apparmor/*" -name "snap-confine.core.*" | xargs -n 1 -P 1 -IXXX rm -f XXX
find /data1/ -xdev -type f -path "*/var/cache/apparmor/*" -name "snap-confine.snapd.*" | xargs -n 1 -P 1 -IXXX rm -f XXX
